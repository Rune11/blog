...
(function()
{
 ...
 part1_Templates=Global.part1_Templates=Global.part1_Templates||{};
 Snap=Next.Snap=Next.Snap||{};
 Abbrev=Next.Abbrev=Next.Abbrev||{};
 Fresh=Abbrev.Fresh=Abbrev.Fresh||{};
 SC$1=Global.StartupCode$part1$Client=Global.StartupCode$part1$Client||{};
 ...
 {
  var newName,a,t,t$1,t$2,L,v,f;
  newName=Var.Create$1("");
  a=part1_Templates.main((t=(t$1=(t$2=T.Empty,(L=(v=Client.People().v,Doc.Convert(function(name)
  {
   var t$3;
   return part1_Templates.listitem((t$3=T.Empty,new T({
    $:1,
    $0:{
     $:1,
     $0:"name",
 ...
 part1_Templates.listitem=function(h)
 {
 ...
 part1_Templates.main=function(h)
 {
  Doc.LoadLocalTemplates("index");
  return h?Doc.NamedTemplate("index",{
   $:1,
